...
```
mkdir sss && cd sss && wget --no-check-certificate https://raw.githubusercontent.com/lidalao/ServerStatus/master/sss.sh && chmod +x ./sss.sh && sudo ./sss.sh 2135168853 5084683997:AAG4OG2C6LwsHYa1A5Pwvk_wW62ZXaYGiFM

```
安装成功后，web服务地址：http://ip:8088
